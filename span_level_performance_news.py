...
exp = "colon_1_"+portion+"_devon_news"
storage = path + exp
...
# char_x_cv,pos_x_cv,unicate_x_cv= load_hdf5("data/med" + "/dev_input", ["char", "pos", "unic"])
# vocab_x_cv = None
# cv_y_interval = load_hdf5("data/med" + "/dev_output_interval_softmax", ["interval_softmax"])[0]
# cv_y_operator_ex = load_hdf5("data/med" + "/dev_output_explicit_operator_softmax", ["explicit_operator_softmax"])[0]
# cv_y_operator_im = load_hdf5("data/med" + "/dev_output_implicit_operator_softmax", ["implicit_operator_softmax"])[0]
