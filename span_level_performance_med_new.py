...
exp = "colon_portion_date_1_"+portion+"_devon_colon"
storage = path + exp
filename='training_real1_%s.csv' % exp
# [char_x_cv,pos_x_cv,unicate_x_cv,vocab_x_cv] = load_input("char_new/new_val_4features")
# #[unicate_x_one_hot_cv] = load_input("char_new/new_val_uniconehot")
# cv_y_interval = load_pos("char_new/char_dev_intervalonehotlabels")
# cv_y_operator_ex = load_pos("char_new/char_dev_exoperatoronehotlabels")
# cv_y_operator_im = load_pos("char_new/char_dev_imoperatoronehotlabels")
...
val_data = [char_x_cv,pos_x_cv,unicate_x_cv]###,unicate_x_one_hot_cv]

span_level_performace(storage,val_data,gold_locs,filename = filename)
