...
portion = str(1)
char_x,pos_x,unicate_x = load_hdf5(file_path + "/news_train_input", ["char", "pos", "unic"])
char_x_cv,pos_x_cv,unicate_x_cv= load_hdf5(file_path + "/cvnews_train_input", ["char", "pos", "unic"])

trainy_interval,trainy_operator_ex,trainy_operator_im = load_hdf5(file_path + "/news_train_target", ["interval_softmax","explicit_operator","implicit_operator"])
