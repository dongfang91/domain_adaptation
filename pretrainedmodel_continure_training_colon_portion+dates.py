...
portion = str(1)
char_x,pos_x,unicate_x = load_hdf5(file_path + "/colon_portion_date_1_"+portion+"_train_input", ["char", "pos", "unic"])
char_x_cv,pos_x_cv,unicate_x_cv= load_hdf5(file_path + "/cvcolon_train_input", ["char", "pos", "unic"])

trainy_interval,trainy_operator_ex,trainy_operator_im = load_hdf5(file_path + "/colon_portion_date_1_"+portion+"_train_target", ["interval_softmax","explicit_operator","implicit_operator"])
cv_y_interval,cv_y_operator_ex,cv_y_operator_im = load_hdf5(file_path + "/cvcolon_train_target", ["interval_softmax","explicit_operator","implicit_operator"])
...
sampleweights = list(np.load(file_path+"/colon_portion_date_1_"+portion+"_sample_weights.npy"))
...
exp = "pretrainedon_news_traingingon_colon_portion_date_1_"+portion+"_devon_colon"
target = 3
storage = path + exp

model_trained = load_model("/extra/dongfangxu9/domain_adaptation/data/models/pretrained_news_weights-improvement-799.hdf5")
